...
use crate::{
    commands::{
        ...
        dashboard::{
            ...
            diagnostics_clear, diagnostics_export, diagnostics_list, load_app_preferences,
            load_holiday_countries, load_holiday_year, load_play_snapshot, load_schedule_rules,
            load_setup_state, load_worklog_snapshot, notification_permission_capability,
            notification_permission_state, notification_request_permission, notification_send_test,
            open_system_notification_settings, purchase_reward, reset_all_data, save_app_preferences,
            save_setup_state, sync_gitlab, unequip_reward, update_schedule,
        },
...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            notification_permission_capability,
