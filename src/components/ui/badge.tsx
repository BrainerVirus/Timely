...
const tones = {
  ...
  empty:
    "border-[color:var(--color-border-subtle)] bg-[color:var(--color-tray)] text-muted-foreground",
  non_workday:
    "border-[color:var(--color-border-subtle)] bg-[color:var(--color-field)] text-foreground/80",
} as const;
