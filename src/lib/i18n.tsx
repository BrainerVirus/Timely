...
const enMessages = {
  ...
  "settings.showTrayIconDescription": "Keep Timely available from the system tray while it runs in the background.",
  "settings.closeButtonAction": "When closing the window",
  "settings.closeButtonActionDescription": "Discord-style default: the close button minimizes Timely to the tray instead of quitting.",
  ...
  "settings.updatesDescription": "Check the latest release for your selected update channel and install it when ready.",
  "settings.updatesIdleDescription": "Choose a channel, then check for the newest release available to this app.",
  ...
  "settings.updatesChannelHint": "Stable gets production releases. Unstable gets prerelease builds first.",
  ...
  "settings.updatesReadyDescription": "The update has been installed. Restart Timely to finish applying it.",
  ...
  "settings.aboutSectionDescription": "Check the installed version and release channel for this build.",
...
const esMessages: MessageDictionary = {
  ...
  "settings.showTrayIconDescription": "Mantén Timely disponible en la bandeja del sistema mientras sigue ejecutándose en segundo plano.",
  "settings.closeButtonAction": "Al cerrar la ventana",
  "settings.closeButtonActionDescription": "Como en Discord, el botón de cerrar minimiza Timely a la bandeja en lugar de salir.",
  ...
  "settings.updatesDescription": "Consulta la última release del canal elegido e instálala cuando esté lista.",
  "settings.updatesIdleDescription": "Elige un canal y busca la release más reciente disponible para esta app.",
  ...
  "settings.updatesChannelHint": "Estable recibe releases de producción. Inestable recibe prereleases primero.",
  ...
  "settings.updatesReadyDescription": "La actualización ya se instaló. Reinicia Timely para terminar de aplicarla.",
  "settings.updatesAvailableDescription": "Hay una versión más nueva disponible para el canal seleccionado.",
  ...
  "settings.aboutSectionDescription": "Consulta la versión instalada y el canal de esta compilación.",
...
const ptMessages: MessageDictionary = {
  ...
  "settings.showTrayIconDescription": "Mantenha o Timely disponível na bandeja do sistema enquanto ele continua rodando em segundo plano.",
  "settings.closeButtonAction": "Ao fechar a janela",
  "settings.closeButtonActionDescription": "Como no Discord, o botão de fechar minimiza o Timely para a bandeja em vez de encerrar o app.",
  ...
  "settings.updatesDescription": "Confira a release mais recente do canal escolhido e instale quando estiver pronta.",
  "settings.updatesIdleDescription": "Escolha um canal e verifique a release mais recente disponível para este app.",
  ...
  "settings.updatesChannelHint": "Estável recebe releases de produção. Instável recebe prereleases primeiro.",
  ...
  "settings.updatesReadyDescription": "A atualização já foi instalada. Reinicie o Timely para concluir a aplicação.",
  "settings.updatesAvailableDescription": "Há uma build mais nova disponível para o canal selecionado.",
