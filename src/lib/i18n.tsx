...
const enMessages = {
  ...
  "settings.closeButtonAction": "Close button",
...
const esMessages: MessageDictionary = {
  ...
  "settings.showTrayIconDescription": "Mantiene Timely disponible desde la bandeja del sistema mientras sigue ejecutándose en segundo plano.",
  "settings.closeButtonAction": "Botón de cerrar",
  "settings.closeButtonActionDescription": "Valor por defecto estilo Discord: el botón cerrar minimiza Timely a la bandeja en vez de salir.",
  "settings.closeActionMinimizeToTray": "Minimizar a la bandeja",
  "settings.closeActionQuit": "Salir de la app",
  "settings.traySummaryCloseToTray": "Bandeja activa · cerrar minimiza a la bandeja",
  "settings.traySummaryKeepTray": "Bandeja activa · cerrar sale de la app",
  "settings.traySummaryDisabled": "Bandeja desactivada · cerrar sale de la app",
...
const ptMessages: MessageDictionary = {
  ...
  "settings.windowBehavior": "Comportamento da janela",
  "settings.showTrayIcon": "Mostrar icone na bandeja",
  "settings.showTrayIconDescription": "Mantem o Timely disponivel na bandeja do sistema enquanto continua rodando em segundo plano.",
  "settings.closeButtonAction": "Botao de fechar",
  "settings.closeButtonActionDescription": "Padrao estilo Discord: o botao de fechar minimiza o Timely para a bandeja em vez de sair.",
  "settings.closeActionMinimizeToTray": "Minimizar para a bandeja",
  "settings.closeActionQuit": "Sair do app",
  "settings.traySummaryCloseToTray": "Bandeja ativa · fechar minimiza para a bandeja",
  "settings.traySummaryKeepTray": "Bandeja ativa · fechar sai do app",
  "settings.traySummaryDisabled": "Bandeja desligada · fechar sai do app",
  "settings.themeSummary": ({ theme, timeFormat }) => `Tema: ${theme} · Hora: ${timeFormat}`,
