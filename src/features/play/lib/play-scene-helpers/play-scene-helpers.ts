...
export type HabitatSceneConfig = {
...
export const HABITAT_SCENE_CONFIG: Record<HabitatSceneKey, HabitatSceneConfig> = {
  aurora: {
...
export function getEnvironmentHabitatScene(
  ...
  return reward.environmentSceneKey || (reward.rewardKey as HabitatSceneKey);
}
