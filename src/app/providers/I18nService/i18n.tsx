...
const enMessages = {
  ...
  "common.issuesBoard": "Assigned issues",
  "common.year": "Year",
  ...
  "sync.summaryCounts": ({ projects, entries, issues, assigned }) =>
    `${projects} projects, ${entries} entries, ${issues} issues, ${assigned} assigned`,
  "sync.summaryPartial": ({ counts, providers }) =>
    `Partially synced ${counts}. ${providers} needs attention.`,
  "sync.summaryDone": ({ counts }) => `Synced ${counts}.`,
  "sync.failureNoProviders": "Sync failed before any provider completed.",
  "sync.failureHeader": ({ failures }) => `Sync could not complete. ${failures}`,
  "sync.providerNetworkFailure": ({ provider }) =>
    `${provider} could not be reached. Try again when the connection is stable.`,
  "sync.providerAuthFailure": ({ provider }) =>
    `${provider} needs sign-in or connection settings to be checked.`,
  "sync.providerReportedFailure": ({ provider }) => `${provider} reported an error during sync.`,
  "sync.providerUnknownFailure": ({ provider }) => `${provider} stopped for an unexpected reason.`,
  "sync.providerSuccess": ({ provider }) => `${provider} synced successfully.`,
  "sync.providerFallback": "Provider",
  ...
  "issues.openExternalIssue": ({ product }) => `Open in ${product}`,
  "issues.issueActions": "Issue actions",
  "issues.deleteIssue": "Delete issue",
  "issues.issueDeleted": "Issue deleted",
  "issues.issueDeleteFailed": "Could not delete issue",
  "issues.confirmDeleteIssueTitle": "Delete issue?",
  "issues.confirmDeleteIssueDescription":
    "This will permanently delete the issue in GitLab. This action cannot be undone.",
  "issues.createdByMeta": ({ author, createdAt }) => `Created ${createdAt} by ${author}`,
  "issues.logTimeSection": "Log time",
  "issues.addTimeTitle": "Add time",
  "issues.addTimeDescription": "Pick an assigned issue and register time for the selected day.",
  "issues.issuePickerLabel": "Issue",
  "issues.issuePickerPlaceholder": "Filter by key, title, or provider...",
  "issues.selectedIssue": "Selected issue",
  "issues.chooseIssueToContinue": "Choose an issue to continue.",
  "issues.timeSpent": "Duration",
  "issues.durationInputLegend": "Spent time",
  "issues.durationWeeks": "Weeks",
  "issues.durationDays": "Days",
  "issues.durationHours": "Hours",
  "issues.durationMinutes": "Minutes",
  "issues.durationWeeksShort": "w",
  "issues.durationDaysShort": "d",
  "issues.durationHoursShort": "h",
  "issues.durationMinutesShort": "m",
  "issues.durationAddMinutes": ({ count }) => `Add ${count} minutes`,
  "issues.durationAddHours": ({ count }) =>
    `Add ${count} ${Number(count) === 1 ? "hour" : "hours"}`,
  "issues.durationClear": "clear",
  "issues.durationClearAria": "Clear duration",
  "issues.durationNoTimeSelected": "No time selected",
  "issues.spentDatePicker": "Spent date",
  "issues.summaryField": "Summary",
  "issues.spentDate": "Date",
  "issues.summaryOptional": "Summary (optional)",
  "issues.submitTime": "Submit time",
  "issues.commentSection": "Comment",
  "issues.commentPlaceholder": "Write a comment or drag your files here...",
  "issues.submitComment": "Post comment",
  "issues.closeIssueAction": "Close issue",
  "issues.reopenIssueAction": "Reopen issue",
  "issues.timeLoggedOnProduct": ({ product }) => `Time logged on ${product}`,
  ...
  "issues.linkedItemsEmpty": "No linked items yet for this issue.",
  "issues.childItemsEmpty": "No child items yet for this issue.",
  ...
  "issues.projectField": "Project",
  "issues.typeField": "Type",
  "issues.priorityField": "Priority",
  "issues.editStatus": "Edit status",
  "issues.selectStatus": "Select status",
  "issues.labelsField": "Labels",
  "issues.editLabels": "Edit labels",
  "issues.editField": "Edit",
  "issues.spentTimeField": "Spent time",
  "issues.startDateField": "Start date",
  "issues.dueDateField": "Due date",
  "issues.estimateWeightField": "Estimate / Weight",
  "issues.participantsField": "Participants",
  "issues.parentField": "Parent",
  "issues.noTimeLogged": "No time logged",
  "issues.logTimeAction": "Log time",
  "issues.selectLabels": "Select labels",
  "issues.milestoneField": "Milestone",
  "issues.editMilestone": "Edit milestone",
  "issues.selectMilestone": "Select milestone",
  "issues.noMilestoneAssigned": "No milestone assigned",
  "issues.unassignMilestone": "Unassign milestone",
  "issues.iterationField": "Iteration",
  "issues.editIteration": "Edit iteration",
  "issues.selectIteration": "Select iteration",
  "issues.unassignIteration": "Unassign iteration",
  ...
  "issues.editComment": "Edit",
  "issues.deleteComment": "Delete",
  "issues.saveComment": "Save changes",
  "issues.cancelCommentEdit": "Cancel",
  "issues.confirmDeleteComment": "Delete this comment? This cannot be undone.",
  "issues.commentUpdated": "Comment updated",
  "issues.commentUpdateFailed": "Could not update the comment",
  "issues.commentDeleted": "Comment deleted",
  "issues.commentDeleteFailed": "Could not delete the comment",
  ...
  "providers.connectYouTrack": "Connect YouTrack",
  "providers.linkYouTrack": "Link your YouTrack workspace to track work items.",
  "providers.youTrackHost": "YouTrack host",
  "providers.youTrackToken": "Permanent Token",
  "providers.youTrackTokenHint":
    "Connect with a permanent token. OAuth is not required for YouTrack.",
  "providers.youTrackConnected": "YouTrack connected.",
...
const esMessages: MessageDictionary = {
  ...
  "common.issuesBoard": "Incidencias asignadas",
  "common.year": "Año",
  ...
  "sync.summaryCounts": ({ projects, entries, issues, assigned }) =>
    `${projects} proyectos, ${entries} entradas, ${issues} incidencias, ${assigned} asignadas`,
  "sync.summaryPartial": ({ counts, providers }) =>
    `Sincronización parcial: ${counts}. ${providers} requiere atención.`,
  "sync.summaryDone": ({ counts }) => `Sincronización completada: ${counts}.`,
  "sync.failureNoProviders": "La sincronización falló antes de completar ningún proveedor.",
  "sync.failureHeader": ({ failures }) => `No se pudo completar la sincronización. ${failures}`,
  "sync.providerNetworkFailure": ({ provider }) =>
    `No se pudo contactar con ${provider}. Inténtalo de nuevo cuando la conexión esté estable.`,
  "sync.providerAuthFailure": ({ provider }) =>
    `${provider} necesita que revises el inicio de sesión o la configuración de conexión.`,
  "sync.providerReportedFailure": ({ provider }) =>
    `${provider} informó un error durante la sincronización.`,
  "sync.providerUnknownFailure": ({ provider }) => `${provider} se detuvo por un motivo inesperado.`,
  "sync.providerSuccess": ({ provider }) => `${provider} se sincronizó correctamente.`,
  "sync.providerFallback": "Proveedor",
  ...
  "issues.openExternalIssue": ({ product }) => `Abrir en ${product}`,
  "issues.issueActions": "Acciones de la incidencia",
  "issues.deleteIssue": "Eliminar incidencia",
  "issues.issueDeleted": "Incidencia eliminada",
  "issues.issueDeleteFailed": "No se pudo eliminar la incidencia",
  "issues.confirmDeleteIssueTitle": "¿Eliminar incidencia?",
  "issues.confirmDeleteIssueDescription":
    "Esto eliminará la incidencia de forma permanente en GitLab. Esta acción no se puede deshacer.",
  "issues.createdByMeta": ({ author, createdAt }) => `Creada ${createdAt} por ${author}`,
  "issues.logTimeSection": "Registrar tiempo",
  "issues.addTimeTitle": "Agregar tiempo",
  "issues.addTimeDescription":
    "Elige una incidencia asignada y registra tiempo para el día seleccionado.",
  "issues.issuePickerLabel": "Incidencia",
  "issues.issuePickerPlaceholder": "Filtrar por clave, título o proveedor...",
  "issues.selectedIssue": "Incidencia seleccionada",
  "issues.chooseIssueToContinue": "Elige una incidencia para continuar.",
  "issues.timeSpent": "Duración",
  "issues.durationInputLegend": "Tiempo registrado",
  "issues.durationWeeks": "Semanas",
  "issues.durationDays": "Días",
  "issues.durationHours": "Horas",
  "issues.durationMinutes": "Minutos",
  "issues.durationWeeksShort": "sem",
  "issues.durationDaysShort": "d",
  "issues.durationHoursShort": "h",
  "issues.durationMinutesShort": "min",
  "issues.durationAddMinutes": ({ count }) => `Agregar ${count} minutos`,
  "issues.durationAddHours": ({ count }) =>
    `Agregar ${count} ${Number(count) === 1 ? "hora" : "horas"}`,
  "issues.durationClear": "borrar",
  "issues.durationClearAria": "Borrar duración",
  "issues.durationNoTimeSelected": "Sin tiempo seleccionado",
  "issues.spentDatePicker": "Fecha de registro",
  "issues.summaryField": "Resumen",
  ...
  "issues.commentPlaceholder": "Escribe un comentario o arrastra tus archivos aquí...",
  "issues.submitComment": "Publicar comentario",
  "issues.closeIssueAction": "Cerrar incidencia",
  "issues.reopenIssueAction": "Reabrir incidencia",
  "issues.timeLoggedOnProduct": ({ product }) => `Tiempo registrado en ${product}`,
  ...
  "issues.linkedItemsEmpty": "Todavía no hay elementos vinculados para esta incidencia.",
  "issues.childItemsEmpty": "Todavía no hay elementos hijos para esta incidencia.",
  ...
  "issues.projectField": "Proyecto",
  "issues.typeField": "Tipo",
  "issues.priorityField": "Prioridad",
  "issues.editStatus": "Editar estado",
  "issues.selectStatus": "Elegir estado",
  "issues.labelsField": "Etiquetas",
  "issues.editLabels": "Editar etiquetas",
  "issues.editField": "Editar",
  "issues.spentTimeField": "Tiempo registrado",
  "issues.startDateField": "Fecha de inicio",
  "issues.dueDateField": "Fecha límite",
  "issues.estimateWeightField": "Estimación / Peso",
  "issues.participantsField": "Participantes",
  "issues.parentField": "Elemento principal",
  "issues.noTimeLogged": "Sin tiempo registrado",
  "issues.logTimeAction": "Registrar tiempo",
  "issues.selectLabels": "Elegir etiquetas",
  "issues.milestoneField": "Hito",
  "issues.editMilestone": "Editar hito",
  "issues.selectMilestone": "Elegir hito",
  "issues.noMilestoneAssigned": "Sin hito asignado",
  "issues.unassignMilestone": "Quitar hito",
  "issues.iterationField": "Iteración",
  "issues.editIteration": "Editar iteración",
  "issues.selectIteration": "Elegir iteración",
  "issues.unassignIteration": "Quitar iteración",
  ...
  "issues.commentDeleteFailed": "No se pudo eliminar el comentario",
  ...
  "settings.issueCodeTheme": "Resaltado de código",
  "settings.issueCodeThemeHint":
    "Elige cómo se ven los bloques de código en descripciones, actividad y vista previa.",
  ...
  "providers.connectYouTrack": "Conectar YouTrack",
  "providers.linkYouTrack": "Vincula tu espacio de YouTrack para registrar elementos de trabajo.",
  "providers.youTrackHost": "Host de YouTrack",
  "providers.youTrackToken": "Token permanente",
  "providers.youTrackTokenHint":
    "Conéctate con un token permanente. OAuth no es necesario para YouTrack.",
  "providers.youTrackConnected": "YouTrack conectado.",
  ...
  "setup.providerTitle": "Conectar un proveedor",
...
const ptMessages: MessageDictionary = {
  ...
  "common.week": "Semana",
  "common.worklog": "Worklog",
  "common.issuesBoard": "Itens atribuídos a você",
  "common.year": "Ano",
  ...
  "sync.toastCompleteDescription": ({ projects, entries, issues }) =>
    `${projects} projetos, ${entries} registros e ${issues} itens sincronizados.`,
  "sync.toastFailedTitle": "Falha na sincronização",
  "sync.summaryCounts": ({ projects, entries, issues, assigned }) =>
    `${projects} projetos, ${entries} registros, ${issues} itens, ${assigned} atribuídos`,
  "sync.summaryPartial": ({ counts, providers }) =>
    `Sincronização parcial: ${counts}. ${providers} precisa de atenção.`,
  "sync.summaryDone": ({ counts }) => `Sincronização concluída: ${counts}.`,
  "sync.failureNoProviders": "A sincronização falhou antes de qualquer provedor terminar.",
  "sync.failureHeader": ({ failures }) => `Não foi possível concluir a sincronização. ${failures}`,
  "sync.providerNetworkFailure": ({ provider }) =>
    `${provider} não pôde ser acessado. Tente novamente quando a conexão estiver estável.`,
  "sync.providerAuthFailure": ({ provider }) =>
    `${provider} precisa que você revise o acesso ou as configurações de conexão.`,
  "sync.providerReportedFailure": ({ provider }) =>
    `${provider} informou um erro durante a sincronização.`,
  "sync.providerUnknownFailure": ({ provider }) => `${provider} parou por um motivo inesperado.`,
  "sync.providerSuccess": ({ provider }) => `${provider} sincronizou corretamente.`,
  "sync.providerFallback": "Provedor",
  "sync.slowSyncWarning":
  ...
  "issues.noIterationFilter": "Sem iteração",
  "issues.filterFortnight": "Período da iteração",
  "issues.filterWorkflowStatus": "Estado",
  "issues.filterProvider": "Provedor",
  "issues.filterAll": "Todos",
  ...
  "issues.openExternalIssue": ({ product }) => `Abrir no ${product}`,
  "issues.issueActions": "Ações do item",
  "issues.deleteIssue": "Excluir item",
  "issues.issueDeleted": "Item excluído",
  "issues.issueDeleteFailed": "Não foi possível excluir o item",
  "issues.confirmDeleteIssueTitle": "Excluir item?",
  "issues.confirmDeleteIssueDescription":
    "Isso excluirá o item permanentemente no GitLab. Esta ação não pode ser desfeita.",
  "issues.createdByMeta": ({ author, createdAt }) => `Criada ${createdAt} por ${author}`,
  "issues.logTimeSection": "Registrar tempo",
  "issues.addTimeTitle": "Adicionar tempo",
  "issues.addTimeDescription": "Escolha um item atribuído e registre tempo para o dia selecionado.",
  "issues.issuePickerLabel": "Item",
  "issues.issuePickerPlaceholder": "Filtrar por chave, título ou provedor...",
  "issues.selectedIssue": "Item selecionado",
  "issues.chooseIssueToContinue": "Escolha um item para continuar.",
  "issues.timeSpent": "Duração",
  "issues.durationInputLegend": "Tempo registrado",
  "issues.durationWeeks": "Semanas",
  "issues.durationDays": "Dias",
  "issues.durationHours": "Horas",
  "issues.durationMinutes": "Minutos",
  "issues.durationWeeksShort": "sem",
  "issues.durationDaysShort": "d",
  "issues.durationHoursShort": "h",
  "issues.durationMinutesShort": "min",
  "issues.durationAddMinutes": ({ count }) => `Adicionar ${count} minutos`,
  "issues.durationAddHours": ({ count }) =>
    `Adicionar ${count} ${Number(count) === 1 ? "hora" : "horas"}`,
  "issues.durationClear": "limpar",
  "issues.durationClearAria": "Limpar duração",
  "issues.durationNoTimeSelected": "Nenhum tempo selecionado",
  "issues.spentDatePicker": "Data do registro",
  "issues.summaryField": "Resumo",
  ...
  "issues.commentPlaceholder": "Escreva um comentário ou arraste seus arquivos aqui...",
  "issues.submitComment": "Publicar comentário",
  "issues.closeIssueAction": "Fechar item",
  "issues.reopenIssueAction": "Reabrir item",
  "issues.timeLoggedOnProduct": ({ product }) => `Tempo registrado no ${product}`,
  ...
  "issues.linkedItemsEmpty": "Ainda não há itens vinculados para este item.",
  "issues.childItemsEmpty": "Ainda não há itens filhos para este item.",
  "issues.systemAuthor": "Sistema",
  "issues.activitySystem": "Sistema",
  ...
  "issues.statusField": "Estado",
  "issues.projectField": "Projeto",
  "issues.typeField": "Tipo",
  "issues.priorityField": "Prioridade",
  "issues.editStatus": "Editar estado",
  "issues.selectStatus": "Escolher estado",
  "issues.labelsField": "Etiquetas",
  "issues.editLabels": "Editar etiquetas",
  "issues.editField": "Editar",
  "issues.spentTimeField": "Tempo registrado",
  "issues.startDateField": "Data de início",
  "issues.dueDateField": "Data limite",
  "issues.estimateWeightField": "Estimativa / Peso",
  "issues.participantsField": "Participantes",
  "issues.parentField": "Item principal",
  "issues.noTimeLogged": "Sem tempo registrado",
  "issues.logTimeAction": "Registrar tempo",
  "issues.selectLabels": "Escolher etiquetas",
  "issues.milestoneField": "Marco",
  "issues.editMilestone": "Editar marco",
  "issues.selectMilestone": "Escolher marco",
  "issues.noMilestoneAssigned": "Sem marco atribuído",
  "issues.unassignMilestone": "Remover marco",
  "issues.iterationField": "Iteração",
  "issues.editIteration": "Editar iteração",
  "issues.selectIteration": "Escolher iteração",
  "issues.unassignIteration": "Remover iteração",
  ...
  "issues.commentDeleteFailed": "Não foi possível excluir o comentário",
  ...
  "settings.themeSummary": ({ theme }) => `Tema: ${theme}`,
  "settings.issueCodeTheme": "Realce de código",
  "settings.issueCodeThemeHint":
    "Escolha como os blocos de código aparecem nas descrições, na atividade e na visualização.",
  ...
  "providers.connect": "Conectar",
  "providers.connectYouTrack": "Conectar YouTrack",
  "providers.linkYouTrack": "Conecte seu espaço YouTrack para registrar itens de trabalho.",
  "providers.youTrackHost": "Host do YouTrack",
  "providers.youTrackToken": "Token permanente",
  "providers.youTrackTokenHint":
    "Conecte-se com um token permanente. OAuth não é necessário para YouTrack.",
  "providers.youTrackConnected": "YouTrack conectado.",
  ...
  "setup.providerTitle": "Conectar um provedor",
  "setup.providerDescription": "Conecte sua conta para começar a registrar tempo.",
...
const enVoiceOverrides = {
  ...
  "setup.providerDescription": "Connect a provider so Timely knows where the work lives.",
...
const esVoiceOverrides = {
  ...
  "setup.providerDescription": "Conecta un proveedor para que Timely sepa dónde vive el trabajo.",
...
const ptVoiceOverrides = {
  ...
  "setup.providerDescription": "Conecte um provedor para o Timely saber onde o trabalho mora.",
